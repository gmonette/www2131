...
#' subtitle: "MATH 2131: Introduction to Statistics II -- Winter 2024"
#' date: "January 2024"
...
#'   - In-class closed-book 50-minute midterm on Wednesday, February 28. 
...
#' - __Final exam: 30%__ Written closed-book 2-hour exam during the regular exam period.
#' - __Assignments: 20%__
#'     - Combination of individual and team assignments. Assigned approximately weekly or bi-weekly. 
#'       Most are done on Piazza. 
...
#'             - The team member responsible for a question posts a tentative solution on Piazza before __deadline #1__. 
...
#'               photograph to Piazza. Use Rmarkdown if you know how.  If you do use Rmarkdown, post your script as well
#'               as the rendered pdf file.
...
#'             - Provide feedback on the solutions posted by your teammates: suggestions for improvements, 
#'               improving coding in R if relevant, 
...
#'         - Instructors will select some solutions as interesting sample solutions and add them to the __star__ folder.  
...
#'           It means that some aspect of it was particularly
...
#'   Every Friday create a post that is private to the Instructor 
...
#'   - Be sure to choose the __feedback__ folder when you post your feedback.
...
#' # Prerequisites
#'
#' The prerequisites for taking this course are MATH 1131, MATH 2030 and 
#' one of MATH 2015 or MATH 2310. 
#' You must have passed **all** of these courses **before** taking MATH 2131. 
...
#' 
#' - John A. Rice (2007) _Mathematical Statistics and Data Analysis, 3rd ed._, Cengage.
#'   - The book is out of print but access to an online version can be purchased through the Bookstore.
#'   - If you buy a used copy, be sure to get the 3rd edition so the numbering of exercises
#'     will be correct for assignments.
#'
#' <!--- 
#' # References
#' 
...
#'   on [Piazza](https://piazza.com/yorku.ca/winter2024/math2131). Post your
...
#' - You can get help in the [Stat Lab](http://mathstats.info.yorku.ca/need-help/) in S525 Ross.
#'
...
#' **may be forbidden in other courses.**  When you use such sources, cite and **credit**
#' their answers in your answer, and include an analysis and critique of their
#' answers.  Some of the material of this course involves recognizing fallacies and paradoxes in
...
#' and its source are cited and that you include your own critical analysis of the material.**  
#' 
...
#' 
#' **The fact that these sources are allowed in this course will not be a
#' defense for using them in other courses in which they are not allowed.**
#'   
